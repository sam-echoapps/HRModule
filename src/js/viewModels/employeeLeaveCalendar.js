...
function (oj,ko,$, app, ojconverterutils_i18n_1, ArrayDataProvider,  ojknockout_keyset_1,ResponsiveUtils, ResponsiveKnockoutUtils, AsyncRegExpValidator) {
    ...
    class employeeLeaveCalendarViewModel {
        constructor(args) {
            var self = this;
            ...
            function getCalendar(){
              ...
              $.ajax({
                  ...
                  success: function (result) {
                      ...
                      if(data.length !=0){ 
                          for (var i = 0; i < data.length; i++) {
                            ...
                            var startDateParts = data[i][1]
                            var day = parseInt(startDateParts.split('-')[2]);
                            var month = parseInt(startDateParts.split('-')[1]);
                            var year = parseInt(startDateParts.split('-')[0]);
                            console.log(day);
                            console.log(month);
                            console.log(year);
                            eventsArr.push(
                  ...
                  //     ]
                      ...
                      eventsArr.push(...JSON.parse(JSON.stringify(eventsArr)));
                      initCalendar()
    ...
    return  employeeLeaveCalendarViewModel;
});